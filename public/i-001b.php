 ...
 * @LastEditTime: 2020-08-21 14:03:57
 * @LastEditors: （谁改的请在此处留上大名^-^）
 * @Description: 上传首营商品修改信息/JKY_goods_gsp_u
 * @FilePath: \www.rhtapi.com\public\i-001b.php
 */ 
...
function update_goods_gsp_u($ukid,$zt,$code,$msg,$subCode,$contextId){

  include("connect.php"); 

  $sql=" update JKY_GOODS_GSP_U set zt = '".$zt."',code = '".$code."',msg = '".$msg."',
...
function upload_goods_gsp_u($res){
  ...
  {
    update_goods_gsp_u($Rows[$x]["ukid"],$zt,$code,$msg,$subCode,$contextId);
  }
...
//主程序
$result = get_goods_gsp_u();

echo upload_goods_gsp_u($result);
